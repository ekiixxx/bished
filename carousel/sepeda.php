  ...
  <main>
    <section>
      <center>
        ...
        <br>
        <button style="background-color: #216286; "><a href="sepeda.php" role="button">Sepeda</a></button>
        <button><a href="skuter.php" role="button">Skuter</a></button>
  ...
  <table>
    <thead>
      <tr>
        ...
        <th><center>Tipe Sepeda</center></th>
        <th><center>Harga Sepeda /jam</center></th>
        <th><center>Stok Sepeda</center></th>
    ...
    <tbody>
      <?php
        $query = "SELECT * FROM daftarmobil where nama like '%Sepeda%'";
